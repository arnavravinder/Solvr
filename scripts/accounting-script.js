...
startBtn.addEventListener('click',()=>{
    ...
    const qpCode=`0452_${selectedMonth}${yearStr}_qp_1${selectedVariant}`;
    const msCode=`0452_${selectedMonth}${yearStr}_ms_1${selectedVariant}`;
    localStorage.setItem('paperCode',qpCode);
    localStorage.setItem('msCode',msCode);
    localStorage.setItem('subject','Accounting');
